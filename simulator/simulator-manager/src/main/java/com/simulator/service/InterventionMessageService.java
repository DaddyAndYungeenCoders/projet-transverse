...
public class InterventionMessageService {
    ...
    private static MovingTeamService movingTeamService;
    ...
    public static void OnIntervention(String message) {
        ...
        try {
            InterventionMessageDTO interventionMessageDTO = objectMapper.readValue(message.toString(), InterventionMessageDTO.class);
