...
class MqttClient:
    ...
    def publish_new_fire_event(self, fire_event):
        self.client.publish(topics.get(TOPIC_RF2_FIRE_EVENT), fire_event)
        print(f"Publish to {topics.get(TOPIC_RF2_FIRE_EVENT)} : {fire_event}")
